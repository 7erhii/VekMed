      ...
      >
        ...
        <div className={`hero__cards ${styles.heroCardsContainer}`}>
          <button className={`card`}>
            <Image src={imageCard1} className={styles.heroCardImageFirst} alt="cardImage" />
          </button>
          <button className={`card`}>
            <Image src={imageCard2} className={styles.heroCardImageSecond} alt="cardImage" />
          </button>
          <button className={`card`}>
            <Image src={imageCard3} className={styles.heroCardImageThird} alt="cardImage" />
          </button>
          <button className={`card`}>
            <Image src={imageCard4} className={styles.heroCardImageFourth} alt="cardImage" />
          </button>
        </div>
        <div className={`hero__actions ${styles.heroActions}`}>
          ...
          <button className={`${styles.heroButton} ${styles.heroButtonActive}`}>
